...
export default class Clock extends React.Component {
	...
	render() {
		return (
			<div classNameName="_clock" style = {"styles"}>
		        <div className="frame">
		            ...
		            <g id="backdrop">
		                <g id="backdrop_disk">
		                    <circle cx="657.5" cy="657.5" r="657.5" className="backdrop-disk"/>
		                    <g id="back_marks">
		                        <g id="XMLID_5_">
		                            <path d="M694.8 23.3L592.7 125.4M643.7 101.2L601 143.9M713.3 31.7l-42.7 42.6M721.7 50.2L619.6 152.3M721.7 125.4L619.6 23.3M643.7 74.4L601 31.7M713.3 143.9l-42.7-42.7M694.8 152.3L592.7 50.2" className="st1"/>
		                            <g transform="matrix(0.7071 -0.7071 0.7071 0.7071 130.4026 490.4157)">
		                                <ellipse cx="657.2" cy="87.8" className="st1" rx="70.2" ry="70.2"/>
		                                <ellipse cx="657.2" cy="87.8" className="st2" rx="60.8" ry="60.8"/>
		                                <ellipse cx="657.2" cy="87.8" className="st3" rx="51.3" ry="51.3"/>
		                                <ellipse cx="657.2" cy="87.8" className="st4" rx="41.9" ry="41.9"/>
		                                <ellipse cx="657.2" cy="87.8" className="st5" rx="32.5" ry="32.5"/>
		                            </g>
		                        </g>
		                        <g id="XMLID_6_">
		                            <path d="M694.8 1162.7l-102.1 102.1M643.7 1240.7l-42.7 42.6M713.3 1171.1l-42.7 42.7M721.7 1189.6l-102.1 102.1M721.7 1264.8l-102.1-102.1M643.7 1213.8l-42.7-42.7M713.3 1283.3l-42.7-42.7M694.8 1291.7l-102.1-102.1" className="st1"/>
		                            <g transform="matrix(0.7071 -0.7071 0.7071 0.7071 -675.2776 824.1394)">
		                                <ellipse cx="657.2" cy="1227.2" className="st1" rx="70.2" ry="70.2"/>
		                                <ellipse cx="657.2" cy="1227.2" className="st2" rx="60.8" ry="60.8"/>
		                                <ellipse cx="657.2" cy="1227.2" className="st3" rx="51.3" ry="51.3"/>
		                                <ellipse cx="657.2" cy="1227.2" className="st4" rx="41.9" ry="41.9"/>
		                                <ellipse cx="657.2" cy="1227.2" className="st5" rx="32.5" ry="32.5"/>
		                            </g>
		                        </g>
		                        <g id="XMLID_8_">
		                            <path d="M372.6 89.5l-37.3 139.4M367.4 182.5l-15.6 58.3M392.9 87.4l-15.6 58.4M409.4 99.3L372 238.8M447 164.4l-139.5-37.3M354 159.2l-58.4-15.6M449 184.7L390.7 169M437.1 201.2l-139.4-37.4" className="st1"/>
		                            <g transform="matrix(0.2588 -0.9659 0.9659 0.2588 117.436 481.2928)">
		                                <ellipse cx="372.3" cy="164.1" className="st1" rx="70.2" ry="70.2"/>
		                                <ellipse cx="372.3" cy="164.1" className="st2" rx="60.8" ry="60.8"/>
		                                <ellipse cx="372.3" cy="164.1" className="st3" rx="51.3" ry="51.3"/>
		                                <ellipse cx="372.3" cy="164.1" className="st4" rx="41.9" ry="41.9"/>
		                                <ellipse cx="372.3" cy="164.1" className="st5" rx="32.5" ry="32.5"/>
		                            </g>
		                        </g>
		                        <g id="XMLID_7_">
		                            <path d="M942.3 1076.2L905 1215.7M937.1 1169.2l-15.6 58.4M962.6 1074.2l-15.6 58.3M979.1 1086.1l-37.4 139.4M1016.7 1151.2l-139.5-37.4M923.7 1146l-58.4-15.7M1018.7 1171.4l-58.3-15.6M1006.8 1187.9l-139.4-37.3" className="st1"/>
		                            <g transform="matrix(0.2588 -0.9659 0.9659 0.2588 -413.4417 1762.9449)">
		                                <ellipse cx="942" cy="1150.9" className="st1" rx="70.2" ry="70.2"/>
		                                <ellipse cx="942" cy="1150.9" className="st2" rx="60.8" ry="60.8"/>
		                                <ellipse cx="942" cy="1150.9" className="st3" rx="51.3" ry="51.3"/>
		                                <ellipse cx="942" cy="1150.9" className="st4" rx="41.9" ry="41.9"/>
		                                <ellipse cx="942" cy="1150.9" className="st5" rx="32.5" ry="32.5"/>
		                            </g>
		                        </g>
		                        <g id="XMLID_10_">
		                            <path d="M126.8 307.8l37.3 139.5M168.7 391l15.7 58.3M143.3 296l15.6 58.3M163.5 298l37.4 139.5M228.6 335.6L89.2 373M145.4 377.6l-58.3 15.6M240.5 352.1l-58.3 15.6M238.5 372.3L99 409.7" className="st1"/>
		                            <g transform="matrix(0.9659 -0.2588 0.2588 0.9659 -90.867 55.0946)">
		                                <ellipse cx="163.8" cy="372.6" className="st1" rx="70.2" ry="70.2"/>
		                                <ellipse cx="163.8" cy="372.6" className="st2" rx="60.8" ry="60.8"/>
		                                <ellipse cx="163.8" cy="372.6" className="st3" rx="51.3" ry="51.3"/>
		                                <ellipse cx="163.8" cy="372.6" className="st4" rx="41.9" ry="41.9"/>
		                                <ellipse cx="163.8" cy="372.6" className="st5" rx="32.5" ry="32.5"/>
		                            </g>
		                        </g>
		                        <g id="XMLID_9_">
		                            <path d="M1113.5 877.5l37.4 139.5M1155.5 960.7l15.6 58.3M1130 865.7l15.6 58.3M1150.2 867.7l37.4 139.5M1215.4 905.3l-139.5 37.4M1132.2 947.3l-58.3 15.6M1227.3 921.8l-58.4 15.6M1225.2 942l-139.4 37.4" className="st1"/>
		                            <g transform="matrix(0.9659 -0.2588 0.2588 0.9659 -204.6939 329.8972)">
		                                <ellipse cx="1150.6" cy="942.4" className="st1" rx="70.2" ry="70.2"/>
		                                <ellipse cx="1150.6" cy="942.4" className="st2" rx="60.8" ry="60.8"/>
		                                <ellipse cx="1150.6" cy="942.4" className="st3" rx="51.3" ry="51.3"/>
		                                <ellipse cx="1150.6" cy="942.4" className="st4" rx="41.9" ry="41.9"/>
		                                <ellipse cx="1150.6" cy="942.4" className="st5" rx="32.5" ry="32.5"/>
		                            </g>
		                        </g>
		                        <g id="XMLID_12_">
		                            <path d="M23 619.9L125.1 722M100.9 670.9l42.7 42.7M31.3 601.4L74 644.1M49.9 593L152 695.1M125.1 593L23 695.1M74 670.9l-42.7 42.7M143.6 601.4l-42.7 42.7M152 619.9L49.9 722" className="st1"/>
		                            <g transform="matrix(0.7071 -0.7071 0.7071 0.7071 -439.2994 254.4375)">
		                                <ellipse cx="87.5" cy="657.5" className="st1" rx="70.2" ry="70.2"/>
		                                <ellipse cx="87.5" cy="657.5" className="st2" rx="60.8" ry="60.8"/>
		                                <ellipse cx="87.5" cy="657.5" className="st3" rx="51.3" ry="51.3"/>
		                                <ellipse cx="87.5" cy="657.5" className="st4" rx="41.9" ry="41.9"/>
		                                <ellipse cx="87.5" cy="657.5" className="st5" rx="32.5" ry="32.5"/>
		                            </g>
		                        </g>
		                        <g id="XMLID_11_">
		                            <path d="M1162.4 619.9L1264.5 722M1240.3 670.9l42.7 42.7M1170.7 601.4l42.7 42.7M1189.3 593l102.1 102.1M1264.5 593l-102.1 102.1M1213.4 670.9l-42.7 42.7M1283 601.4l-42.7 42.7M1291.4 619.9L1189.3 722" className="st1"/>
		                            <g transform="matrix(0.7071 -0.7071 0.7071 0.7071 -105.5757 1060.1177)">
		                                <ellipse cx="1226.9" cy="657.5" className="st1" rx="70.2" ry="70.2"/>
		                                <ellipse cx="1226.9" cy="657.5" className="st2" rx="60.8" ry="60.8"/>
		                                <ellipse cx="1226.9" cy="657.5" className="st3" rx="51.3" ry="51.3"/>
		                                <ellipse cx="1226.9" cy="657.5" className="st4" rx="41.9" ry="41.9"/>
		                                <ellipse cx="1226.9" cy="657.5" className="st5" rx="32.5" ry="32.5"/>
		                            </g>
		                        </g>
		                        <g id="XMLID_14_">
		                            <path d="M89.2 942l139.4 37.4M182.2 947.3l58.3 15.6M87.1 921.8l58.3 15.6M99 905.3l139.5 37.4M164.1 867.7l-37.3 139.5M158.9 960.7l-15.6 58.3M184.4 865.7L168.7 924M200.9 877.5L163.5 1017" className="st1"/>
		                            <g transform="matrix(0.2588 -0.9659 0.9659 0.2588 -788.829 856.68)">
		                                <ellipse cx="163.8" cy="942.4" className="st1" rx="70.2" ry="70.2"/>
		                                <ellipse cx="163.8" cy="942.4" className="st2" rx="60.8" ry="60.8"/>
		                                <ellipse cx="163.8" cy="942.4" className="st3" rx="51.3" ry="51.3"/>
		                                <ellipse cx="163.8" cy="942.4" className="st4" rx="41.9" ry="41.9"/>
		                                <ellipse cx="163.8" cy="942.4" className="st5" rx="32.5" ry="32.5"/>
		                            </g>
		                        </g>
		                        <g id="XMLID_13_">
		                            <path d="M1075.9 372.3l139.5 37.4M1168.9 377.6l58.4 15.6M1073.9 352.1l58.3 15.6M1085.8 335.6l139.4 37.4M1150.9 298l-37.4 139.5M1145.6 391l-15.6 58.3M1171.1 296l-15.6 58.3M1187.6 307.8l-37.4 139.5" className="st1"/>
		                            <g transform="matrix(0.2588 -0.9659 0.9659 0.2588 492.8232 1387.5577)">
		                                <ellipse cx="1150.6" cy="372.6" className="st1" rx="70.2" ry="70.2"/>
		                                <ellipse cx="1150.6" cy="372.6" className="st2" rx="60.8" ry="60.8"/>
		                                <ellipse cx="1150.6" cy="372.6" className="st3" rx="51.3" ry="51.3"/>
		                                <ellipse cx="1150.6" cy="372.6" className="st4" rx="41.9" ry="41.9"/>
		                                <ellipse cx="1150.6" cy="372.6" className="st5" rx="32.5" ry="32.5"/>
		                            </g>
		                        </g>
		                        <g id="XMLID_16_">
		                            <path d="M307.5 1187.9l139.5-37.3M390.7 1146l58.3-15.7M295.6 1171.4l58.4-15.6M297.7 1151.2l139.4-37.4M335.3 1086.1l37.3 139.4M377.3 1169.2l15.6 58.4M351.8 1074.2l15.6 58.3M372 1076.2l37.4 139.5" className="st1"/>
		                            <g transform="matrix(0.9659 -0.2588 0.2588 0.9659 -285.1817 135.5824)">
		                                <ellipse cx="372.3" cy="1150.9" className="st1" rx="70.2" ry="70.2"/>
		                                <ellipse cx="372.3" cy="1150.9" className="st2" rx="60.8" ry="60.8"/>
		                                <ellipse cx="372.3" cy="1150.9" className="st3" rx="51.3" ry="51.3"/>
		                                <ellipse cx="372.3" cy="1150.9" className="st4" rx="41.9" ry="41.9"/>
		                                <ellipse cx="372.3" cy="1150.9" className="st5" rx="32.5" ry="32.5"/>
		                            </g>
		                        </g>
		                        <g id="XMLID_15_">
		                            <path d="M877.2 201.2l139.5-37.4M960.4 159.2l58.3-15.6M865.3 184.7l58.4-15.7M867.4 164.4l139.4-37.3M905 99.3l37.3 139.5M947 182.5l15.6 58.3M921.5 87.4l15.6 58.4M941.7 89.5l37.4 139.4" className="st1"/>
		                            <g transform="matrix(0.9659 -0.2588 0.2588 0.9659 -10.3792 249.4093)">
		                                <ellipse cx="942" cy="164.1" className="st1" rx="70.2" ry="70.2"/>
		                                <ellipse cx="942" cy="164.1" className="st2" rx="60.8" ry="60.8"/>
		                                <ellipse cx="942" cy="164.1" className="st3" rx="51.3" ry="51.3"/>
		                                <ellipse cx="942" cy="164.1" className="st4" rx="41.9" ry="41.9"/>
		                                <ellipse cx="942" cy="164.1" className="st5" rx="32.5" ry="32.5"/>
		                            </g>
		                        </g>
		                        <g id="XMLID_33_">
		                            <path d="M529.4 35.2l-72.2 125M500.2 123.7L470 176M549.4 38.4l-30.2 52.3M562.3 54.2l-72.2 125M581.8 126.8L456.7 54.6M493.3 97.7L441 67.5M578.5 146.9l-52.3-30.2M562.7 159.8l-125-72.2" className="st1"/>
		                            <g transform="matrix(0.5 -0.866 0.866 0.5 162.0211 495.0492)">
		                                <ellipse cx="509.7" cy="107.2" className="st1" rx="70.2" ry="70.2"/>
		                                <ellipse cx="509.7" cy="107.2" className="st2" rx="60.8" ry="60.8"/>
		                                <ellipse cx="509.7" cy="107.2" className="st3" rx="51.3" ry="51.3"/>
		                                <ellipse cx="509.7" cy="107.2" className="st4" rx="41.9" ry="41.9"/>
		                                <ellipse cx="509.7" cy="107.2" className="st5" rx="32.5" ry="32.5"/>
		                            </g>
		                        </g>
		                        <g id="XMLID_32_">
		                            <path d="M824.3 1135.8l-72.2 125M795.1 1224.3l-30.2 52.3M844.3 1139l-30.2 52.3M857.2 1154.8l-72.2 125M876.7 1227.4l-125.1-72.2M788.2 1198.3l-52.3-30.2M873.4 1247.5l-52.3-30.2M857.6 1260.4l-125-72.2" className="st1"/>
		                            <g transform="matrix(0.5 -0.866 0.866 0.5 -643.6591 1300.7294)">
		                                <ellipse cx="804.6" cy="1207.8" className="st1" rx="70.2" ry="70.2"/>
		                                <ellipse cx="804.6" cy="1207.8" className="st2" rx="60.8" ry="60.8"/>
		                                <ellipse cx="804.6" cy="1207.8" className="st3" rx="51.3" ry="51.3"/>
		                                <ellipse cx="804.6" cy="1207.8" className="st4" rx="41.9" ry="41.9"/>
		                                <ellipse cx="804.6" cy="1207.8" className="st5" rx="32.5" ry="32.5"/>
		                            </g>
		                        </g>
		                        <g id="XMLID_31_">
		                            <path d="M235.3 182.5v144.4M254.3 273.7v60.4M254.3 175.3v60.3M273.4 182.5v144.4M326.5 235.6H182.2M235.3 254.7h-60.4M333.7 254.7h-60.3M326.5 273.7H182.2" className="st1"/>
		                            <circle cx="254.3" cy="254.7" r="70.2" className="st1"/>
		                            <circle cx="254.3" cy="254.7" r="60.8" className="st2"/>
		                            <circle cx="254.3" cy="254.7" r="51.3" className="st3"/>
		                            <circle cx="254.3" cy="254.7" r="41.9" className="st4"/>
		                            <circle cx="254.3" cy="254.7" r="32.5" className="st5"/>
		                        </g>
		                        <g id="XMLID_30_">
		                            <path d="M1041 988.1v144.4M1060 1079.4v60.3M1060 980.9v60.4M1079 988.1v144.4M1132.2 1041.3H987.8M1041 1060.3h-60.4M1139.4 1060.3H1079M1132.2 1079.4H987.8" className="st1"/>
		                            <circle cx="1060" cy="1060.3" r="70.2" className="st1"/>
		                            <circle cx="1060" cy="1060.3" r="60.8" className="st2"/>
		                            <circle cx="1060" cy="1060.3" r="51.3" className="st3"/>
		                            <circle cx="1060" cy="1060.3" r="41.9" className="st4"/>
		                            <circle cx="1060" cy="1060.3" r="32.5" className="st5"/>
		                        </g>
		                        <g id="XMLID_29_">
		                            <path d="M54.3 457l72.2 125.1M116.4 526.5l30.2 52.3M67.2 441.3l30.2 52.3M87.3 438l72.2 125.1M159.9 457.5l-125 72.2M90.4 519.6l-52.3 30.2M175.7 470.3l-52.3 30.2M178.9 490.4l-125 72.2" className="st1"/>
		                            <g transform="matrix(0.866 -0.5 0.5 0.866 -240.7038 121.7816)">
		                                <ellipse cx="106.9" cy="510.1" className="st1" rx="70.2" ry="70.2"/>
		                                <ellipse cx="106.9" cy="510.1" className="st2" rx="60.8" ry="60.8"/>
		                                <ellipse cx="106.9" cy="510.1" className="st3" rx="51.3" ry="51.3"/>
		                                <ellipse cx="106.9" cy="510.1" className="st4" rx="41.9" ry="41.9"/>
		                                <ellipse cx="106.9" cy="510.1" className="st5" rx="32.5" ry="32.5"/>
		                            </g>
		                        </g>
		                        <g id="XMLID_28_">
		                            <path d="M1154.9 751.9l72.2 125.1M1217 821.4l30.2 52.3M1167.8 736.2l30.2 52.3M1187.9 732.9L1260 858M1260.5 752.4l-125.1 72.2M1191 814.5l-52.3 30.2M1276.2 765.2l-52.3 30.2M1279.5 785.3l-125 72.2" className="st1"/>
		                            <g transform="matrix(0.866 -0.5 0.5 0.866 -240.7038 711.5804)">
		                                <ellipse cx="1207.5" cy="804.9" className="st1" rx="70.2" ry="70.2"/>
		                                <ellipse cx="1207.5" cy="804.9" className="st2" rx="60.8" ry="60.8"/>
		                                <ellipse cx="1207.5" cy="804.9" className="st3" rx="51.3" ry="51.3"/>
		                                <ellipse cx="1207.5" cy="804.9" className="st4" rx="41.9" ry="41.9"/>
		                                <ellipse cx="1207.5" cy="804.9" className="st5" rx="32.5" ry="32.5"/>
		                            </g>
		                        </g>
		                        <g id="XMLID_27_">
		                            <path d="M34.9 785.3l125 72.2M123.4 814.5l52.3 30.2M38.1 765.2l52.3 30.2M53.9 752.4l125 72.2M126.5 732.9L54.3 858M97.4 821.4l-30.2 52.3M146.6 736.2l-30.2 52.3M159.5 751.9L87.3 877" className="st1"/>
		                            <g transform="matrix(0.5 -0.866 0.866 0.5 -643.6591 495.0492)">
		                                <ellipse cx="106.9" cy="804.9" className="st1" rx="70.2" ry="70.2"/>
		                                <ellipse cx="106.9" cy="804.9" className="st2" rx="60.8" ry="60.8"/>
		                                <ellipse cx="106.9" cy="804.9" className="st3" rx="51.3" ry="51.3"/>
		                                <ellipse cx="106.9" cy="804.9" className="st4" rx="41.9" ry="41.9"/>
		                                <ellipse cx="106.9" cy="804.9" className="st5" rx="32.5" ry="32.5"/>
		                            </g>
		                        </g>
		                        <g id="XMLID_26_">
		                            <path d="M1135.4 490.4l125.1 72.2M1223.9 519.6l52.3 30.2M1138.7 470.3l52.3 30.2M1154.5 457.5l125 72.2M1227.1 438l-72.2 125.1M1198 526.5l-30.2 52.3M1247.2 441.3l-30.2 52.3M1260 457l-72.1 125.1" className="st1"/>
		                            <g transform="matrix(0.5 -0.866 0.866 0.5 162.0211 1300.7294)">
		                                <ellipse cx="1207.5" cy="510.1" className="st1" rx="70.2" ry="70.2"/>
		                                <ellipse cx="1207.5" cy="510.1" className="st2" rx="60.8" ry="60.8"/>
		                                <ellipse cx="1207.5" cy="510.1" className="st3" rx="51.3" ry="51.3"/>
		                                <ellipse cx="1207.5" cy="510.1" className="st4" rx="41.9" ry="41.9"/>
		                                <ellipse cx="1207.5" cy="510.1" className="st5" rx="32.5" ry="32.5"/>
		                            </g>
		                        </g>
		                        <g id="XMLID_25_">
		                            <path d="M182.2 1079.4h144.3M273.4 1060.3h60.3M174.9 1060.3h60.4M182.2 1041.3h144.3M235.3 988.1v144.4M254.3 1079.4v60.3M254.3 980.9v60.4M273.4 988.1v144.4" className="st1"/>
		                            <circle cx="254.3" cy="1060.3" r="70.2" className="st1"/>
		                            <circle cx="254.3" cy="1060.3" r="60.8" className="st2"/>
		                            <circle cx="254.3" cy="1060.3" r="51.3" className="st3"/>
		                            <circle cx="254.3" cy="1060.3" r="41.9" className="st4"/>
		                            <circle cx="254.3" cy="1060.3" r="32.5" className="st5"/>
		                        </g>
		                        <g id="XMLID_24_">
		                            <path d="M987.8 273.7h144.4M1079 254.7h60.4M980.6 254.7h60.4M987.8 235.6h144.4M1041 182.5v144.4M1060 273.7v60.4M1060 175.3v60.3M1079 182.5v144.4" className="st1"/>
		                            <circle cx="1060" cy="254.7" r="70.2" className="st1"/>
		                            <circle cx="1060" cy="254.7" r="60.8" className="st2"/>
		                            <circle cx="1060" cy="254.7" r="51.3" className="st3"/>
		                            <circle cx="1060" cy="254.7" r="41.9" className="st4"/>
		                            <circle cx="1060" cy="254.7" r="32.5" className="st5"/>
		                        </g>
		                        <g id="XMLID_23_">
		                            <path d="M456.7 1260.4l125.1-72.2M526.2 1198.3l52.3-30.2M441 1247.5l52.3-30.2M437.7 1227.4l125-72.2M457.2 1154.8l72.2 125M519.2 1224.3l30.2 52.3M470 1139l30.2 52.3M490.1 1135.8l72.2 125" className="st1"/>
		                            <g transform="matrix(0.866 -0.5 0.5 0.866 -535.6033 416.681)">
		                                <ellipse cx="509.7" cy="1207.8" className="st1" rx="70.2" ry="70.2"/>
		                                <ellipse cx="509.7" cy="1207.8" className="st2" rx="60.8" ry="60.8"/>
		                                <ellipse cx="509.7" cy="1207.8" className="st3" rx="51.3" ry="51.3"/>
		                                <ellipse cx="509.7" cy="1207.8" className="st4" rx="41.9" ry="41.9"/>
		                                <ellipse cx="509.7" cy="1207.8" className="st5" rx="32.5" ry="32.5"/>
		                            </g>
		                        </g>
		                        <g id="XMLID_22_">
		                            <path d="M751.6 159.8l125.1-72.2M821.1 97.7l52.3-30.2M735.9 146.9l52.3-30.2M732.6 126.8l125-72.2M752.1 54.2l72.2 125M814.1 123.7l30.2 52.3M764.9 38.4l30.2 52.3M785 35.2l72.2 125" className="st1"/>
		                            <g transform="matrix(0.866 -0.5 0.5 0.866 54.1956 416.681)">
		                                <ellipse cx="804.6" cy="107.2" className="st1" rx="70.2" ry="70.2"/>
		                                <ellipse cx="804.6" cy="107.2" className="st2" rx="60.8" ry="60.8"/>
		                                <ellipse cx="804.6" cy="107.2" className="st3" rx="51.3" ry="51.3"/>
		                                <ellipse cx="804.6" cy="107.2" className="st4" rx="41.9" ry="41.9"/>
		                                <ellipse cx="804.6" cy="107.2" className="st5" rx="32.5" ry="32.5"/>
		                            </g>
		                        </g>
		                        ...
		                        <circle cx="657.5" cy="657.5" r="640.4" className="st6"/>
		                    </g>
		                    ...
		                    <circle id="backdrop_glow" cx="657.5" cy="657.5" r="419.9" className="backdrop-glow-gradient"/>
		                </g>
		            </g>
		            <g id="WOS">
		            ...
		            <g id="frontframe">
		                ...
		                <g id="screw_6_">
		                    ...
		                    <circle cx="966.2" cy="535.2" r="11.1" className="st15"/>
		                    <linearGradient id="SVGID_7_" x1="970.158" x2="961.891" y1="539.355" y2="531.087" gradientUnits="userSpaceOnUse">
		                        <stop offset="0" style="stop-color:#666666"/>
		                        <stop offset="1" style="stop-color:#0D0D0D"/>
		                    </linearGradient>
		                    <path d="M968.8 530.5h-5.5l-2.8 4.7 2.8 4.8h5.5l2.7-4.8z" className="st16"/>
		                </g>
		                <g id="hole_11_">
		                    ...
		                    <circle cx="1022.1" cy="561.1" r="6.9" className="st17"/>
		                </g>
		                <g id="hole_10_">
		                    ...
		                    <circle cx="986.2" cy="629" r="6.9" className="st18"/>
		                </g>
		                <g id="hole_9_">
		                    ...
		                    <circle cx="532.8" cy="585.6" r="6.9" className="st19"/>
		                </g>
		                <g id="hole_8_">
		                    ...
		                    <circle cx="756.3" cy="854.1" r="4" className="st20"/>
		                </g>
		                <g id="hole_7_">
		                    ...
		                    <circle cx="701.3" cy="985.1" r="4" className="st21"/>
		                </g>
		                <g id="hole_6_">
		                    ...
		                    <circle cx="620.3" cy="986.1" r="6.9" className="st22"/>
		                </g>
		                <g id="hole_5_">
		                    ...
		                    <circle cx="741.8" cy="791.6" r="6.9" className="st23"/>
		                </g>
		                <g id="hole_4_">
		                    ...
		                    <circle cx="395.9" cy="860.6" r="4.7" className="st24"/>
		                </g>
		                <g id="hole_3_">
		                    ...
		                    <circle cx="555.9" cy="631.6" r="4.7" className="st25"/>
		                </g>
		                <g id="hole_2_">
		                    ...
		                    <circle cx="328.3" cy="616.6" r="4.7" className="st26"/>
		                </g>
		                <g id="hole_1_">
		                    ...
		                    <circle cx="678" cy="334.8" r="5.4" className="st27"/>
		                </g>
		                <g id="hole">
		                    ...
		                    <circle cx="607.8" cy="350.1" r="6.9" className="st28"/>
		                </g>
		                <g id="screw_5_">
		            ...
		            <g id="gears_front">
		                ...
		                <g id="screw_4_">
		                    ...
		                    <circle cx="768.1" cy="732" r="9" className="st31"/>
		                    <linearGradient id="SVGID_25_" x1="771.395" x2="764.512" y1="735.476" y2="728.593" gradientUnits="userSpaceOnUse">
		                        <stop offset="0" style="stop-color:#666666"/>
		                        <stop offset="1" style="stop-color:#0D0D0D"/>
		                    </linearGradient>
		                    <path d="M770.2 728.2h-4.5l-2.2 3.8 2.2 3.9h4.5l2.2-3.9z" className="st32"/>
		                </g>
		            </g>
		            <g id="face_frame">
		                ...
		                <g id="screw_3_">
		                    ...
		                    <circle cx="955.3" cy="359.3" r="12.3" className="st34"/>
		                    ...
		                    <path d="M961 357.7l-4.2-4.3-5.9 1.6-1.6 5.8 4.3 4.3 5.9-1.6z" className="st35"/>
		                </g>
		                <g id="screw_2_">
		                    ...
		                    <circle cx="359" cy="955.7" r="12.3" className="st36"/>
		                    ...
		                    <path d="M364.7 954l-4.3-4.3-5.8 1.6-1.6 5.8 4.3 4.3 5.8-1.5z" className="st37"/>
		                </g>
		                <g id="screw_1_">
		                    ...
		                    <circle cx="359" cy="359.3" r="12.3" className="st38"/>
		                    ...
		                    <path d="M353.3 357.7l4.3-4.3 5.9 1.6 1.5 5.8-4.2 4.3-5.9-1.6z" className="st39"/>
		                </g>
		                <g id="screw">
		                    ...
		                    <circle cx="955.3" cy="955.7" r="12.3" className="st40"/>
		                    ...
		                    <path d="M949.7 954l4.2-4.3 5.9 1.6 1.6 5.8-4.3 4.3-5.9-1.5z" className="st41"/>
		                </g>
		                <g id="knobs">
		                    <g id="knob11">
		                        ...
		                        <circle cx="446.5" cy="292.6" r="65.6" className="st42"/>
		                        <circle cx="446.8" cy="292.3" r="66.8" className="primary-stroke-b"/>
		                        <circle cx="446.8" cy="292.3" r="62.5" className="primary-stroke-a"/>
		                    </g>
		                    <g id="knob10">
		                        ...
		                        <circle cx="292.2" cy="446.8" r="65.6" className="st45"/>
		                        <circle cx="292.6" cy="446.6" r="66.8" className="primary-stroke-b"/>
		                        <circle cx="292.6" cy="446.6" r="62.5" className="primary-stroke-a"/>
		                    </g>
		                    <g id="knob09">
		                        ...
		                        <circle cx="235.8" cy="657.5" r="65.6" className="st46"/>
		                        <circle cx="236.1" cy="657.3" r="66.8" className="primary-stroke-b"/>
		                        <circle cx="236.1" cy="657.3" r="62.5" className="primary-stroke-a"/>
		                    </g>
		                    <g id="knob08">
		                        ...
		                        <circle cx="292.2" cy="868.2" r="65.6" className="st47"/>
		                        <circle cx="292.6" cy="868" r="66.8" className="primary-stroke-b"/>
		                        <circle cx="292.6" cy="868" r="62.5" className="primary-stroke-a"/>
		                    </g>
		                    <g id="knob07">
		                        ...
		                        <circle cx="446.5" cy="1022.4" r="65.6" className="st48"/>
		                        <circle cx="446.8" cy="1022.2" r="66.8" className="primary-stroke-b"/>
		                        <circle cx="446.8" cy="1022.2" r="62.5" className="primary-stroke-a"/>
		                    </g>
		                    <g id="knob06">
		                        ...
		                        <circle cx="658.3" cy="1077.9" r="65.6" className="st49"/>
		                        <circle cx="658.7" cy="1077.6" r="66.8" className="primary-stroke-b"/>
		                        <circle cx="658.7" cy="1077.6" r="62.5" className="primary-stroke-a"/>
		                    </g>
		                    <g id="knob05">
		                        ...
		                        <circle cx="867.9" cy="1022.4" r="65.6" className="st50"/>
		                        <circle cx="868.2" cy="1022.2" r="66.8" className="primary-stroke-b"/>
		                        <circle cx="868.2" cy="1022.2" r="62.5" className="primary-stroke-a"/>
		                    </g>
		                    <g id="knob04">
		                        ...
		                        <circle cx="1022.1" cy="868.2" r="65.6" className="st51"/>
		                        <circle cx="1022.4" cy="868" r="66.8" className="primary-stroke-b"/>
		                        <circle cx="1022.4" cy="868" r="62.5" className="primary-stroke-a"/>
		                    </g>
		                    <g id="knob03">
		                        ...
		                        <circle cx="1078.6" cy="657.7" r="65.6" className="st52"/>
		                        <circle cx="1078.9" cy="657.4" r="66.8" className="primary-stroke-b"/>
		                        <circle cx="1078.9" cy="657.4" r="62.5" className="primary-stroke-a"/>
		                    </g>
		                    <g id="knob02">
		                        ...
		                        <circle cx="1022.1" cy="446.8" r="65.6" className="st53"/>
		                        <circle cx="1022.4" cy="446.6" r="66.8" className="primary-stroke-b"/>
		                        <circle cx="1022.4" cy="446.6" r="62.5" className="primary-stroke-a"/>
		                    </g>
		                    <g id="knob01">
		                        ...
		                        <circle cx="868" cy="292.9" r="65.6" className="st54"/>
		                        <circle cx="868.3" cy="292.7" r="66.8" className="primary-stroke-b"/>
		                        <circle cx="868.3" cy="292.7" r="62.5" className="primary-stroke-a"/>
		                    </g>
		                    <g id="knob12">
		            ...
		            <g id="face_marks">
		                ...
		                <g id="three">
		                    <path d="M1113.7 632.6v-2.9c0-.2.1-.3.2-.4.1-.1.3-.1.4-.1.2 0 .3 0 .5.1.1.1.2.2.2.4v15.9c0 .2-.1.3-.2.4-.1.1-.3.2-.4.2-.2 0-.4-.1-.5-.2-.1-.1-.2-.3-.2-.4v-2.9h-71v2.9c-.2.3-.4.5-.6.5-.2 0-.4-.2-.6-.5v-16.3c.2-.4.4-.5.6-.5s.4.2.6.5v3.3h71zM1113.7 651.8v-2.9c0-.2.1-.3.2-.4.1-.1.3-.1.4-.1.2 0 .3 0 .5.1.1.1.2.2.2.4v15.9c0 .2-.1.3-.2.4-.1.1-.3.2-.4.2-.2 0-.4-.1-.5-.2-.1-.1-.2-.3-.2-.4v-2.9h-71v2.9c-.2.3-.4.5-.6.5-.2 0-.4-.2-.6-.5v-16.3c.2-.4.4-.5.6-.5s.4.2.6.5v3.3h71zM1113.7 671v-2.9c0-.2.1-.3.2-.4.1-.1.3-.1.4-.1.2 0 .3 0 .5.1.1.1.2.2.2.4V684c0 .2-.1.3-.2.4-.1.1-.3.2-.4.2-.2 0-.4-.1-.5-.2-.1-.1-.2-.3-.2-.4v-3h-71v2.9c-.2.3-.4.5-.6.5-.2 0-.4-.2-.6-.5v-16.3c.2-.4.4-.5.6-.5s.4.2.6.5v3.3h71z" className="primary-fill"/>
		                </g>
		                <g id="two">
		                    <path d="M1044.8 416.1l-1.5-2.5c-.1-.1-.1-.3 0-.4s.1-.3.3-.3c.2-.1.3-.1.5-.1.1 0 .3.1.3.3l7.9 13.7c.1.1.1.3.1.4 0 .2-.1.3-.3.4-.2.1-.3.1-.5.1s-.3-.1-.4-.3l-1.5-2.5-61.5 35.5 1.5 2.5c0 .4-.1.6-.3.7-.2.1-.4.1-.8-.1l-8.1-14.1c0-.4.1-.7.3-.8s.4 0 .8.2l1.7 2.9 61.5-35.6zM1054.4 432.7l-1.5-2.5c-.1-.1-.1-.3 0-.4 0-.1.1-.3.3-.3.2-.1.3-.1.5-.1.1 0 .3.1.3.3l7.9 13.7c.1.1.1.3.1.4 0 .2-.1.3-.3.4-.2.1-.3.1-.5.1s-.3-.1-.4-.3l-1.5-2.5-61.5 35.5 1.5 2.5c0 .4-.1.6-.3.7-.2.1-.4.1-.8-.1l-8.1-14.1c0-.4.1-.7.3-.8s.4 0 .8.2l1.7 2.9 61.5-35.6z" className="primary-fill"/>
		                </g>
		                <g id="one">
		                    <path d="M880.5 259.4l-2.5-1.5-.3-.3c0-.1 0-.3.1-.4.1-.2.2-.3.4-.3h.4l13.7 7.9c.1.1.2.2.3.4 0 .2 0 .3-.1.4-.1.2-.2.3-.4.3s-.3 0-.4-.1l-2.5-1.5-35.5 61.5 2.5 1.5c.2.4.2.6.1.8-.1.2-.4.3-.7.3l-14.1-8.1c-.2-.4-.3-.6-.2-.8.1-.2.3-.2.8-.3l2.9 1.7 35.5-61.5z" className="primary-fill"/>
		                </g>
		                <g id="twelve">
		                    <path d="M623.9 201h-2.3c-.2 0-.3-.1-.4-.2-.1-.1-.2-.3-.2-.4s.1-.3.2-.4c.1-.1.3-.2.4-.2H638c.2 0 .3.1.4.2.1.1.2.3.2.4s-.1.3-.2.4-.3.2-.4.2h-3.9l6.7 26.3 6-19.4c.3-1.1.5-2.1.5-3 0-1.1-.2-2-.6-2.6-.4-.6-1-.9-1.8-1.1l-2.2-.2c-.2-.1-.3-.3-.3-.6 0-.2.2-.4.5-.6h11c.4.2.5.5.5.7 0 .3-.1.5-.2.6l-1.5.1c-.8.2-1.6.8-2.3 1.6-.8.9-1.3 1.8-1.7 2.9l-7.4 23.8 10.9 42.6h2.2c.4.2.5.4.5.6s0 .3-.1.4-.2.2-.4.2h-15.6c-.2 0-.3-.1-.4-.2-.1-.1-.2-.3-.2-.4s.1-.3.2-.4c.1-.1.3-.2.4-.2h3.4l-7.5-29.1-6.9 22.4c-.3 1-.4 2-.4 3s.3 1.8.9 2.4c.9.9 1.8 1.3 2.6 1.3h1.3c.2 0 .3.1.4.2.1.1.2.3.2.4s-.1.3-.2.4c-.1.1-.3.2-.4.2h-11.5c-.4-.2-.5-.4-.5-.6s0-.3.1-.4c.1-.1.2-.2.4-.2 2.7-.5 4.7-2.9 6-7.2l7.4-24.4-10.2-39.5zM659.8 201h-2.9c-.2 0-.3-.1-.4-.2-.1-.1-.1-.3-.1-.4 0-.2 0-.3.1-.5.1-.1.2-.2.4-.2h15.9c.2 0 .3.1.4.2.1.1.2.3.2.4 0 .2-.1.4-.2.5-.1.1-.3.2-.4.2h-2.9v71h2.9c.3.2.5.4.5.6 0 .2-.2.4-.5.6h-16.3c-.4-.2-.5-.4-.5-.6s.2-.4.5-.6h3.3v-71zM679 201h-2.9c-.2 0-.3-.1-.4-.2-.1-.1-.1-.3-.1-.4 0-.2 0-.3.1-.5.1-.1.2-.2.4-.2H692c.2 0 .3.1.4.2.1.1.2.3.2.4 0 .2-.1.4-.2.5-.1.1-.3.2-.4.2h-3v71h2.9c.3.2.5.4.5.6 0 .2-.2.4-.5.6h-16.3c-.4-.2-.5-.4-.5-.6s.2-.4.5-.6h3.3v-71z" className="primary-fill"/>
		                </g>
		            </g>
		            <path id="ticks_band" d="M657.2 1183.5c-71 0-139.9-13.9-204.8-41.3-62.6-26.5-118.9-64.4-167.2-112.7-48.3-48.3-86.2-104.6-112.7-167.2-27.4-64.9-41.3-133.8-41.3-204.8s13.9-139.9 41.3-204.8c26.5-62.6 64.4-118.9 112.7-167.2 48.3-48.3 104.6-86.2 167.2-112.7 64.9-27.4 133.8-41.3 204.8-41.3s139.9 13.9 204.8 41.3c62.6 26.5 118.9 64.4 167.2 112.7 48.3 48.3 86.2 104.6 112.7 167.2 27.4 64.9 41.3 133.8 41.3 204.8s-13.9 139.9-41.3 204.8c-26.5 62.6-64.4 118.9-112.7 167.2s-104.6 86.2-167.2 112.7c-64.9 27.4-133.8 41.3-204.8 41.3zm0-1022c-273.5 0-496 222.5-496 496s222.5 496 496 496 496-222.5 496-496-222.5-496-496-496z" className="st9"/>
		            <g id="ticks">
		                <path id="minute_tick_59_" d="M663.8 145.5c-.5-2.7-2.6-4.9-5.4-5.4l-1.2-6.7-1.2 6.7c-2.7.5-4.9 2.6-5.4 5.4l-6.7 1.2 6.7 1.2c.5 2.7 2.6 4.9 5.4 5.4l1.2 6.7 1.2-6.7c2.7-.5 4.9-2.6 5.4-5.4l6.7-1.2-6.7-1.2zm-6.6 4.5c-1.8 0-3.3-1.5-3.3-3.3s1.5-3.3 3.3-3.3 3.3 1.5 3.3 3.3-1.5 3.3-3.3 3.3z" className="primary-fill"/>
		                <path id="minute_tick_58_" d="M663.8 1167.1c-.5-2.7-2.6-4.9-5.4-5.4l-1.2-6.7-1.2 6.7c-2.7.5-4.9 2.6-5.4 5.4l-6.7 1.2 6.7 1.2c.5 2.7 2.6 4.9 5.4 5.4l1.2 6.7 1.2-6.7c2.7-.5 4.9-2.6 5.4-5.4l6.7-1.2-6.7-1.2zm-6.6 4.5c-1.8 0-3.3-1.5-3.3-3.3s1.5-3.3 3.3-3.3 3.3 1.5 3.3 3.3-1.5 3.3-3.3 3.3z" className="primary-fill"/>
		                <path id="minute_tick_57_" d="M607.4 148.4c-.4-1.5-1.8-2.6-3.3-2.7L603 142l-.3 3.8c-1.5.4-2.6 1.8-2.7 3.3l-3.7 1.1 3.8.3c.4 1.5 1.8 2.6 3.3 2.7l1.1 3.7.3-3.8c1.5-.4 2.6-1.8 2.7-3.3l3.7-1.1-3.8-.3zm-3.4 2.9c-1 .1-1.9-.6-2-1.6-.1-1 .6-1.9 1.6-2 1-.1 1.9.6 2 1.6.1 1-.6 1.9-1.6 2z" className="primary-fill"/>
		                <path id="minute_tick_56_" d="M714.2 1164.4c-.4-1.5-1.8-2.6-3.3-2.7l-1.1-3.7-.3 3.8c-1.5.4-2.6 1.8-2.7 3.3l-3.7 1.1 3.8.3c.4 1.5 1.8 2.6 3.3 2.7l1.1 3.7.3-3.8c1.5-.4 2.6-1.8 2.7-3.3l3.7-1.1-3.8-.3zm-3.4 2.9c-1 .1-1.9-.6-2-1.6s.6-1.9 1.6-2 1.9.6 2 1.6-.6 1.9-1.6 2z" className="primary-fill"/>
		                <path id="minute_tick_55_" d="M554.5 156.4c-.6-1.4-2-2.4-3.6-2.3l-1.5-3.6.1 3.8c-1.4.6-2.4 2-2.3 3.6l-3.6 1.5 3.8-.1c.6 1.4 2 2.4 3.6 2.3l1.5 3.6-.1-3.8c1.4-.6 2.4-2 2.3-3.6l3.6-1.5-3.8.1zm-3.1 3.3c-1 .2-2-.4-2.2-1.4-.2-1 .4-2 1.4-2.2s2 .4 2.2 1.4c.2 1-.4 1.9-1.4 2.2z" className="primary-fill"/>
		                <path id="minute_tick_54_" d="M766.9 1155.7c-.6-1.4-2-2.4-3.6-2.3l-1.5-3.6.1 3.8c-1.4.6-2.4 2-2.3 3.6l-3.6 1.5 3.8-.1c.6 1.4 2 2.4 3.6 2.3l1.5 3.6-.1-3.8c1.4-.6 2.4-2 2.3-3.6l3.6-1.5-3.8.1zm-3.1 3.2c-1 .2-2-.4-2.2-1.4-.2-1 .4-2 1.4-2.2s2 .4 2.2 1.4c.2 1-.4 2-1.4 2.2z" className="primary-fill"/>
		                <path id="minute_tick_53_" d="M502.7 169.9c-.7-1.4-2.3-2.1-3.8-1.9l-1.8-3.4.5 3.8c-1.4.7-2.1 2.3-1.9 3.8l-3.4 1.8 3.8-.5c.7 1.4 2.3 2.1 3.8 1.9l1.8 3.4-.5-3.8c1.4-.7 2.1-2.3 1.9-3.8l3.4-1.8-3.8.5zm-2.8 3.5c-1 .3-2-.2-2.3-1.2-.3-1 .2-2 1.2-2.3 1-.3 2 .2 2.3 1.2.3 1-.2 2-1.2 2.3z" className="primary-fill"/>
		                <path id="minute_tick_52_" d="M818.3 1141.5c-.7-1.4-2.3-2.1-3.8-1.9l-1.8-3.4.5 3.8c-1.4.7-2.1 2.3-1.9 3.8l-3.4 1.8 3.8-.5c.7 1.4 2.3 2.1 3.8 1.9l1.8 3.4-.5-3.8c1.4-.7 2.1-2.3 1.9-3.8l3.4-1.8-3.8.5zm-2.7 3.5c-1 .3-2-.2-2.3-1.2-.3-1 .2-2 1.2-2.3 1-.3 2 .2 2.3 1.2.3 1-.2 2-1.2 2.3z" className="primary-fill"/>
		                <path id="minute_tick_51_" d="M452.5 188.7c-.9-1.3-2.5-1.9-4-1.5l-2.2-3.2.9 3.7c-1.3.9-1.9 2.5-1.5 4l-3.2 2.2 3.7-.9c.9 1.3 2.5 1.9 4 1.5l2.2 3.2-.9-3.7c1.3-.9 1.9-2.5 1.5-4l3.2-2.2-3.7.9zm-2.3 3.8c-.9.4-2 0-2.4-.9-.4-.9 0-2 .9-2.4.9-.4 2 0 2.4.9.4.9 0 2-.9 2.4z" className="primary-fill"/>
		                <path id="minute_tick_50_" d="M868.1 1122c-.9-1.3-2.5-1.9-4-1.5l-2.2-3.2.9 3.7c-1.3.9-1.9 2.5-1.5 4l-3.2 2.2 3.7-.9c.9 1.3 2.5 1.9 4 1.5l2.2 3.2-.9-3.7c1.3-.9 1.9-2.5 1.5-4l3.2-2.2-3.7.9zm-2.4 3.8c-.9.4-2 0-2.4-.9-.4-.9 0-2 .9-2.4s2 0 2.4.9c.4.9 0 2-.9 2.4z" className="primary-fill"/>
		                <path id="minute_tick_49_" d="M406.9 210.8c-1.8-2.1-4.7-2.9-7.3-2l-4.4-5.2 2.3 6.4c-2.1 1.8-2.9 4.7-2 7.3l-5.2 4.4 6.4-2.3c1.8 2.1 4.7 2.9 7.3 2l4.4 5.2-2.3-6.4c2.1-1.8 2.9-4.7 2-7.3l5.2-4.4-6.4 2.3zm-3.5 7.2c-1.6.9-3.6.4-4.5-1.2s-.4-3.6 1.2-4.5 3.6-.4 4.5 1.2.4 3.6-1.2 4.5z" className="primary-fill"/>
		                <path id="minute_tick_48_" d="M917.7 1095.5c-1.8-2.1-4.7-2.9-7.3-2l-4.4-5.2 2.3 6.4c-2.1 1.8-2.9 4.7-2 7.3l-5.2 4.4 6.4-2.3c1.8 2.1 4.7 2.9 7.3 2l4.4 5.2-2.3-6.4c2.1-1.8 2.9-4.7 2-7.3l5.2-4.4-6.4 2.3zm-3.5 7.2c-1.6.9-3.6.4-4.5-1.2-.9-1.6-.4-3.6 1.2-4.5 1.6-.9 3.6-.4 4.5 1.2.9 1.6.4 3.6-1.2 4.5z" className="primary-fill"/>
		                <path id="minute_tick_47_" d="M359.5 241.5c-1.1-1.1-2.8-1.3-4.2-.7l-2.8-2.7 1.7 3.5c-1.1 1.1-1.3 2.8-.7 4.2l-2.7 2.8 3.5-1.7c1.1 1.1 2.8 1.3 4.2.7l2.8 2.7-1.7-3.5c1.1-1.1 1.3-2.8.7-4.2l2.7-2.8-3.5 1.7zm-1.5 4.2c-.8.6-2 .4-2.6-.4-.6-.8-.4-2 .4-2.6.8-.6 2-.4 2.6.4.6.9.4 2-.4 2.6z" className="primary-fill"/>
		                <path id="minute_tick_46_" d="M960 1068c-1.1-1.1-2.8-1.3-4.2-.7l-2.8-2.7 1.7 3.5c-1.1 1.1-1.3 2.8-.7 4.2l-2.7 2.8 3.5-1.7c1.1 1.1 2.8 1.3 4.2.7l2.8 2.7-1.7-3.5c1.1-1.1 1.3-2.8.7-4.2l2.7-2.8-3.5 1.7zm-1.5 4.2c-.8.6-2 .4-2.6-.4-.6-.8-.4-2 .4-2.6.8-.6 2-.4 2.6.4s.4 2-.4 2.6z" className="primary-fill"/>
		                <path id="minute_tick_45_" d="M317.7 274.9c-1.2-.9-2.9-1-4.3-.2l-3.1-2.3 2 3.3c-.9 1.2-1 2.9-.2 4.3l-2.3 3.1 3.3-2c1.2.9 2.9 1 4.3.2l3.1 2.3-2-3.3c.9-1.2 1-2.9.2-4.3l2.3-3.1-3.3 2zm-1.1 4.4c-.8.7-1.9.6-2.6-.1-.7-.8-.6-1.9.1-2.6.8-.7 1.9-.6 2.6.1.7.7.7 1.9-.1 2.6z" className="primary-fill"/>
		                <path id="minute_tick_44_" d="M1001.3 1034.1c-1.2-.9-2.9-1-4.3-.2l-3.1-2.3 2 3.3c-.9 1.2-1 2.9-.2 4.3l-2.3 3.1 3.3-2c1.2.9 2.9 1 4.3.2l3.1 2.3-2-3.3c.9-1.2 1-2.9.2-4.3l2.3-3.1-3.3 2zm-1.1 4.4c-.8.7-1.9.6-2.6-.1s-.6-1.9.1-2.6c.8-.7 1.9-.6 2.6.1.7.7.7 1.9-.1 2.6z" className="primary-fill"/>
		                <path id="minute_tick_43_" d="M279.6 312.5c-1.3-.8-3-.7-4.3.2l-3.3-2 2.3 3.1c-.8 1.3-.7 3 .2 4.3l-2 3.3 3.1-2.3c1.3.8 3 .7 4.3-.2l3.3 2-2.3-3.1c.8-1.3.7-3-.2-4.3l2-3.3-3.1 2.3zm-.7 4.4c-.7.8-1.8.8-2.6.1-.8-.7-.8-1.8-.1-2.6.7-.8 1.8-.8 2.6-.1.8.7.8 1.9.1 2.6z" className="primary-fill"/>
		                <path id="minute_tick_42_" d="M1038.8 996.1c-1.3-.8-3-.7-4.3.2l-3.3-2 2.3 3.1c-.8 1.3-.7 3 .2 4.3l-2 3.3 3.1-2.3c1.3.8 3 .7 4.3-.2l3.3 2-2.3-3.1c.8-1.3.7-3-.2-4.3l2-3.3-3.1 2.3zm-.7 4.4c-.7.8-1.8.8-2.6.1-.8-.7-.8-1.8-.1-2.6.7-.8 1.8-.8 2.6-.1.8.7.8 1.9.1 2.6z" className="primary-fill"/>
		                <path id="minute_tick_41_" d="M245.6 353.8c-1.4-.7-3.1-.4-4.2.7l-3.5-1.7 2.7 2.8c-.7 1.4-.4 3.1.7 4.2l-1.7 3.5 2.8-2.7c1.4.7 3.1.4 4.2-.7l3.5 1.7-2.7-2.8c.7-1.4.4-3.1-.7-4.2l1.7-3.5-2.8 2.7zm-.2 4.5c-.6.8-1.7 1-2.6.4-.8-.6-1-1.7-.4-2.6s1.7-1 2.6-.4c.8.7 1 1.8.4 2.6z" className="primary-fill"/>
		                <path id="minute_tick_40_" d="M1072.1 954.3c-1.4-.7-3.1-.4-4.2.7l-3.5-1.7 2.7 2.8c-.7 1.4-.4 3.1.7 4.2l-1.7 3.5 2.8-2.7c1.4.7 3.1.4 4.2-.7l3.5 1.7-2.7-2.8c.7-1.4.4-3.1-.7-4.2l1.7-3.5-2.8 2.7zm-.2 4.5c-.6.8-1.7 1-2.6.4-.8-.6-1-1.7-.4-2.6.6-.8 1.7-1 2.6-.4.8.7 1 1.8.4 2.6z" className="primary-fill"/>
		                <path id="minute_tick_39_" d="M217 395.8c-2.6-.9-5.5-.1-7.3 2l-6.4-2.3 5.2 4.4c-.9 2.6-.1 5.5 2 7.3l-2.3 6.4 4.4-5.2c2.6.9 5.5.1 7.3-2l6.4 2.3-5.2-4.4c.9-2.6.1-5.5-2-7.3l2.3-6.4-4.4 5.2zm.6 7.9c-.9 1.6-2.9 2.1-4.5 1.2s-2.1-2.9-1.2-4.5 2.9-2.1 4.5-1.2 2.1 3 1.2 4.5z" className="primary-fill"/>
		                <path id="minute_tick_38_" d="M1101.8 906.6c-2.6-.9-5.5-.1-7.3 2l-6.4-2.3 5.2 4.4c-.9 2.6-.1 5.5 2 7.3l-2.3 6.4 4.4-5.2c2.6.9 5.5.1 7.3-2l6.4 2.3-5.2-4.4c.9-2.6.1-5.5-2-7.3l2.3-6.4-4.4 5.2zm.6 7.9c-.9 1.6-2.9 2.1-4.5 1.2-1.6-.9-2.1-2.9-1.2-4.5.9-1.6 2.9-2.1 4.5-1.2 1.5 1 2.1 3 1.2 4.5z" className="primary-fill"/>
		                <path id="minute_tick_37_" d="M191.4 446.1c-1.5-.4-3.1.2-4 1.5l-3.7-.9 3.2 2.2c-.4 1.5.2 3.1 1.5 4l-.9 3.7 2.2-3.2c1.5.4 3.1-.2 4-1.5l3.7.9-3.2-2.2c.4-1.5-.2-3.1-1.5-4l.9-3.7-2.2 3.2zm.8 4.4c-.4.9-1.5 1.3-2.4.9-.9-.4-1.3-1.5-.9-2.4.4-.9 1.5-1.3 2.4-.9.9.4 1.3 1.5.9 2.4z" className="primary-fill"/>
		                <path id="minute_tick_36_" d="M1124.7 861.6c-1.5-.4-3.1.2-4 1.5l-3.7-.9 3.2 2.2c-.4 1.5.2 3.1 1.5 4l-.9 3.7 2.2-3.2c1.5.4 3.1-.2 4-1.5l3.7.9-3.2-2.2c.4-1.5-.2-3.1-1.5-4l.9-3.7-2.2 3.2zm.8 4.4c-.4.9-1.5 1.3-2.4.9s-1.3-1.5-.9-2.4c.4-.9 1.5-1.3 2.4-.9.9.4 1.3 1.5.9 2.4z" className="primary-fill"/>
		                <path id="minute_tick_35_" d="M171.9 495.9c-1.5-.2-3.1.6-3.8 1.9l-3.8-.5 3.4 1.8c-.2 1.5.6 3.1 1.9 3.8l-.5 3.8 1.8-3.4c1.5.2 3.1-.6 3.8-1.9l3.8.5-3.4-1.8c.2-1.5-.6-3.1-1.9-3.8l.5-3.8-1.8 3.4zm1.2 4.3c-.3 1-1.3 1.5-2.3 1.2-1-.3-1.5-1.3-1.2-2.3.3-1 1.3-1.5 2.3-1.2 1 .3 1.5 1.4 1.2 2.3z" className="primary-fill"/>
		                <path id="minute_tick_34_" d="M1143.5 811.6c-1.5-.2-3.1.6-3.8 1.9l-3.8-.5 3.4 1.8c-.2 1.5.6 3.1 1.9 3.8l-.5 3.8 1.8-3.4c1.5.2 3.1-.6 3.8-1.9l3.8.5-3.4-1.8c.2-1.5-.6-3.1-1.9-3.8l.5-3.8-1.8 3.4zm1.2 4.3c-.3 1-1.3 1.5-2.3 1.2-1-.3-1.5-1.3-1.2-2.3s1.3-1.5 2.3-1.2c1 .3 1.5 1.3 1.2 2.3z" className="primary-fill"/>
		                <path id="minute_tick_33_" d="M157.6 547.5c-1.6 0-3 .9-3.6 2.3l-3.8-.1 3.6 1.5c0 1.6.9 3 2.3 3.6l-.1 3.8 1.5-3.6c1.6 0 3-.9 3.6-2.3l3.8.1-3.6-1.5c0-1.6-.9-3-2.3-3.6l.1-3.8-1.5 3.6zm1.7 4.2c-.2 1-1.2 1.6-2.2 1.4s-1.6-1.2-1.4-2.2 1.2-1.6 2.2-1.4 1.7 1.2 1.4 2.2z" className="primary-fill"/>
		                <path id="minute_tick_32_" d="M1156.9 759.9c-1.6 0-3 .9-3.6 2.3l-3.8-.1 3.6 1.5c0 1.6.9 3 2.3 3.6l-.1 3.8 1.5-3.6c1.6 0 3-.9 3.6-2.3l3.8.1-3.6-1.5c0-1.6-.9-3-2.3-3.6l.1-3.8-1.5 3.6zm1.7 4.2c-.2 1-1.2 1.6-2.2 1.4s-1.6-1.2-1.4-2.2c.2-1 1.2-1.6 2.2-1.4s1.6 1.2 1.4 2.2z" className="primary-fill"/>
		                <path id="minute_tick_31_" d="M148.9 600.3c-1.6.1-2.9 1.2-3.3 2.7l-3.8.3 3.7 1.1c.1 1.6 1.2 2.9 2.7 3.3l.3 3.8 1.1-3.7c1.6-.1 2.9-1.2 3.3-2.7l3.8-.3-3.7-1.1c-.1-1.6-1.2-2.9-2.7-3.3l-.3-3.8-1.1 3.7zm2.1 4c-.1 1-1 1.7-2 1.6-1-.1-1.7-1-1.6-2 .1-1 1-1.7 2-1.6 1 .1 1.7 1 1.6 2z" className="primary-fill"/>
		                <path id="minute_tick_30_" d="M1164.9 707.1c-1.6.1-2.9 1.2-3.3 2.7l-3.8.3 3.7 1.1c.1 1.6 1.2 2.9 2.7 3.3l.3 3.8 1.1-3.7c1.6-.1 2.9-1.2 3.3-2.7l3.8-.3-3.7-1.1c-.1-1.6-1.2-2.9-2.7-3.3l-.3-3.8-1.1 3.7zm2.1 4c-.1 1-1 1.7-2 1.6-1-.1-1.7-1-1.6-2s1-1.7 2-1.6c1 .1 1.7 1 1.6 2z" className="primary-fill"/>
		                <path id="minute_tick_29_" d="M145.1 650.9c-2.7.5-4.9 2.6-5.4 5.4l-6.7 1.2 6.7 1.2c.5 2.7 2.6 4.9 5.4 5.4l1.2 6.7 1.2-6.7c2.7-.5 4.9-2.6 5.4-5.4l6.7-1.2-6.7-1.2c-.5-2.7-2.6-4.9-5.4-5.4l-1.2-6.7-1.2 6.7zm4.5 6.6c0 1.8-1.5 3.3-3.3 3.3s-3.3-1.5-3.3-3.3 1.5-3.3 3.3-3.3 3.3 1.5 3.3 3.3z" className="primary-fill"/>
		                <path id="minute_tick_28_" d="M1166.8 650.9c-2.7.5-4.9 2.6-5.4 5.4l-6.7 1.2 6.7 1.2c.5 2.7 2.6 4.9 5.4 5.4l1.2 6.7 1.2-6.7c2.7-.5 4.9-2.6 5.4-5.4l6.7-1.2-6.7-1.2c-.5-2.7-2.6-4.9-5.4-5.4l-1.2-6.7-1.2 6.7zm4.4 6.6c0 1.8-1.5 3.3-3.3 3.3s-3.3-1.5-3.3-3.3 1.5-3.3 3.3-3.3 3.3 1.5 3.3 3.3z" className="primary-fill"/>
		                <path id="minute_tick_27_" d="M148.1 707.3c-1.5.4-2.6 1.8-2.7 3.3l-3.7 1.1 3.8.3c.4 1.5 1.8 2.6 3.3 2.7l1.1 3.7.3-3.8c1.5-.4 2.6-1.8 2.7-3.3l3.7-1.1-3.8-.3c-.4-1.5-1.8-2.6-3.3-2.7l-1.1-3.7-.3 3.8zm2.9 3.4c.1 1-.6 1.9-1.6 2-1 .1-1.9-.6-2-1.6-.1-1 .6-1.9 1.6-2 1-.1 1.9.6 2 1.6z" className="primary-fill"/>
		                <path id="minute_tick_26_" d="M1164.1 600.5c-1.5.4-2.6 1.8-2.7 3.3l-3.7 1.1 3.8.3c.4 1.5 1.8 2.6 3.3 2.7l1.1 3.7.3-3.8c1.5-.4 2.6-1.8 2.7-3.3l3.7-1.1-3.8-.3c-.4-1.5-1.8-2.6-3.3-2.7l-1.1-3.7-.3 3.8zm2.9 3.4c.1 1-.6 1.9-1.6 2-1 .1-1.9-.6-2-1.6s.6-1.9 1.6-2c1-.1 1.9.6 2 1.6z" className="primary-fill"/>
		                <path id="minute_tick_25_" d="M156.1 760.2c-1.4.6-2.4 2-2.3 3.6l-3.6 1.5 3.8-.1c.6 1.4 2 2.4 3.6 2.3l1.5 3.6-.1-3.8c1.4-.6 2.4-2 2.3-3.6l3.6-1.5-3.8.1c-.6-1.4-2-2.4-3.6-2.3l-1.5-3.6.1 3.8zm3.2 3.1c.2 1-.4 2-1.4 2.2s-2-.4-2.2-1.4.4-2 1.4-2.2 2 .4 2.2 1.4z" className="primary-fill"/>
		                <path id="minute_tick_24_" d="M1155.4 547.8c-1.4.6-2.4 2-2.3 3.6l-3.6 1.5 3.8-.1c.6 1.4 2 2.4 3.6 2.3l1.5 3.6-.1-3.8c1.4-.6 2.4-2 2.3-3.6l3.6-1.5-3.8.1c-.6-1.4-2-2.4-3.6-2.3l-1.5-3.6.1 3.8zm3.2 3.1c.2 1-.4 2-1.4 2.2s-2-.4-2.2-1.4c-.2-1 .4-2 1.4-2.2s2 .4 2.2 1.4z" className="primary-fill"/>
		                <path id="minute_tick_23_" d="M169.6 812c-1.4.7-2.1 2.3-1.9 3.8l-3.4 1.8 3.8-.5c.7 1.4 2.3 2.1 3.8 1.9l1.8 3.4-.5-3.8c1.4-.7 2.1-2.3 1.9-3.8l3.4-1.8-3.8.5c-.7-1.4-2.3-2.1-3.8-1.9l-1.8-3.4.5 3.8zm3.5 2.8c.3 1-.2 2-1.2 2.3s-2-.2-2.3-1.2c-.3-1 .2-2 1.2-2.3 1-.3 2 .2 2.3 1.2z" className="primary-fill"/>
		                <path id="minute_tick_22_" d="M1141.2 496.3c-1.4.7-2.1 2.3-1.9 3.8l-3.4 1.8 3.8-.5c.7 1.4 2.3 2.1 3.8 1.9l1.8 3.4-.5-3.8c1.4-.7 2.1-2.3 1.9-3.8l3.4-1.8-3.8.5c-.7-1.4-2.3-2.1-3.8-1.9l-1.8-3.4.5 3.8zm3.5 2.8c.3 1-.2 2-1.2 2.3-1 .3-2-.2-2.3-1.2s.2-2 1.2-2.3c1-.3 2 .2 2.3 1.2z" className="primary-fill"/>
		                <path id="minute_tick_21_" d="M188.4 862.2c-1.3.9-1.9 2.5-1.5 4l-3.2 2.2 3.7-.9c.9 1.3 2.5 1.9 4 1.5l2.2 3.2-.9-3.7c1.3-.9 1.9-2.5 1.5-4l3.2-2.2-3.7.9c-.9-1.3-2.5-1.9-4-1.5l-2.2-3.2.9 3.7zm3.8 2.3c.4.9 0 2-.9 2.4-.9.4-2 0-2.4-.9s0-2 .9-2.4c.9-.4 2 0 2.4.9z" className="primary-fill"/>
		                <path id="minute_tick_20_" d="M1121.7 446.6c-1.3.9-1.9 2.5-1.5 4l-3.2 2.2 3.7-.9c.9 1.3 2.5 1.9 4 1.5l2.2 3.2-.9-3.7c1.3-.9 1.9-2.5 1.5-4l3.2-2.2-3.7.9c-.9-1.3-2.5-1.9-4-1.5l-2.2-3.2.9 3.7zm3.8 2.4c.4.9 0 2-.9 2.4-.9.4-2 0-2.4-.9-.4-.9 0-2 .9-2.4.9-.4 2 0 2.4.9z" className="primary-fill"/>
		                <path id="minute_tick_19_" d="M210.4 907.8c-2.1 1.8-2.9 4.7-2 7.3l-5.2 4.4 6.4-2.3c1.8 2.1 4.7 2.9 7.3 2l4.4 5.2-2.3-6.4c2.1-1.8 2.9-4.7 2-7.3l5.2-4.4-6.4 2.3c-1.8-2.1-4.7-2.9-7.3-2l-4.4-5.2 2.3 6.4zm7.2 3.5c.9 1.6.4 3.6-1.2 4.5s-3.6.4-4.5-1.2c-.9-1.6-.4-3.6 1.2-4.5s3.6-.4 4.5 1.2z" className="primary-fill"/>
		                <path id="minute_tick_18_" d="M1095.2 397c-2.1 1.8-2.9 4.7-2 7.3l-5.2 4.4 6.4-2.3c1.8 2.1 4.7 2.9 7.3 2l4.4 5.2-2.3-6.4c2.1-1.8 2.9-4.7 2-7.3l5.2-4.4-6.4 2.3c-1.8-2.1-4.7-2.9-7.3-2l-4.4-5.2 2.3 6.4zm7.2 3.5c.9 1.6.4 3.6-1.2 4.5-1.6.9-3.6.4-4.5-1.2-.9-1.6-.4-3.6 1.2-4.5 1.6-.9 3.6-.4 4.5 1.2z" className="primary-fill"/>
		                <path id="minute_tick_17_" d="M241.2 955.1c-1.1 1.1-1.3 2.8-.7 4.2l-2.7 2.8 3.5-1.7c1.1 1.1 2.8 1.3 4.2.7l2.8 2.7-1.7-3.5c1.1-1.1 1.3-2.8.7-4.2l2.7-2.8-3.5 1.7c-1.1-1.1-2.8-1.3-4.2-.7l-2.8-2.7 1.7 3.5zm4.2 1.6c.6.8.4 2-.4 2.6-.8.6-2 .4-2.6-.4-.6-.8-.4-2 .4-2.6.9-.6 2-.5 2.6.4z" className="primary-fill"/>
		                <path id="minute_tick_16_" d="M1067.7 354.7c-1.1 1.1-1.3 2.8-.7 4.2l-2.7 2.8 3.5-1.7c1.1 1.1 2.8 1.3 4.2.7l2.8 2.7-1.7-3.5c1.1-1.1 1.3-2.8.7-4.2l2.7-2.8-3.5 1.7c-1.1-1.1-2.8-1.3-4.2-.7l-2.8-2.7 1.7 3.5zm4.2 1.5c.6.8.4 2-.4 2.6-.8.6-2 .4-2.6-.4-.6-.8-.4-2 .4-2.6.9-.6 2-.4 2.6.4z" className="primary-fill"/>
		                <path id="minute_tick_15_" d="M274.6 997c-.9 1.2-1 2.9-.2 4.3l-2.3 3.1 3.3-2c1.2.9 2.9 1 4.3.2l3.1 2.3-2-3.3c.9-1.2 1-2.9.2-4.3l2.3-3.1-3.3 2c-1.2-.9-2.9-1-4.3-.2l-3.1-2.3 2 3.3zm4.3 1.1c.7.8.6 1.9-.1 2.6-.8.7-1.9.6-2.6-.1-.7-.8-.6-1.9.1-2.6.8-.7 2-.7 2.6.1z" className="primary-fill"/>
		                <path id="minute_tick_14_" d="M1033.8 313.4c-.9 1.2-1 2.9-.2 4.3l-2.3 3.1 3.3-2c1.2.9 2.9 1 4.3.2l3.1 2.3-2-3.3c.9-1.2 1-2.9.2-4.3l2.3-3.1-3.3 2c-1.2-.9-2.9-1-4.3-.2l-3.1-2.3 2 3.3zm4.3 1.1c.7.8.6 1.9-.1 2.6-.8.7-1.9.6-2.6-.1s-.6-1.9.1-2.6c.8-.7 2-.7 2.6.1z" className="primary-fill"/>
		                <path id="minute_tick_13_" d="M312.2 1035.1c-.8 1.3-.7 3 .2 4.3l-2 3.3 3.1-2.3c1.3.8 3 .7 4.3-.2l3.3 2-2.3-3.1c.8-1.3.7-3-.2-4.3l2-3.3-3.1 2.3c-1.3-.8-3-.7-4.3.2l-3.3-2 2.3 3.1zm4.4.6c.8.7.8 1.8.1 2.6-.7.8-1.8.8-2.6.1-.8-.7-.8-1.8-.1-2.6.7-.7 1.9-.7 2.6-.1z" className="primary-fill"/>
		                <path id="minute_tick_12_" d="M995.8 275.9c-.8 1.3-.7 3 .2 4.3l-2 3.3 3.1-2.3c1.3.8 3 .7 4.3-.2l3.3 2-2.3-3.1c.8-1.3.7-3-.2-4.3l2-3.3-3.1 2.3c-1.3-.8-3-.7-4.3.2l-3.3-2 2.3 3.1zm4.4.6c.8.7.8 1.8.1 2.6s-1.8.8-2.6.1c-.8-.7-.8-1.8-.1-2.6s1.9-.7 2.6-.1z" className="primary-fill"/>
		                <path id="minute_tick_11_" d="M353.5 1069.1c-.7 1.4-.4 3.1.7 4.2l-1.7 3.5 2.8-2.7c1.4.7 3.1.4 4.2-.7l3.5 1.7-2.7-2.8c.7-1.4.4-3.1-.7-4.2l1.7-3.5-2.8 2.7c-1.4-.7-3.1-.4-4.2.7l-3.5-1.7 2.7 2.8zm4.5.2c.8.6 1 1.7.4 2.6-.6.8-1.7 1-2.6.4-.8-.6-1-1.7-.4-2.6.7-.8 1.8-1 2.6-.4z" className="primary-fill"/>
		                <path id="minute_tick_10_" d="M954 242.6c-.7 1.4-.4 3.1.7 4.2l-1.7 3.5 2.8-2.7c1.4.7 3.1.4 4.2-.7l3.5 1.7-2.7-2.8c.7-1.4.4-3.1-.7-4.2l1.7-3.5-2.8 2.7c-1.4-.7-3.1-.4-4.2.7l-3.5-1.7 2.7 2.8zm4.5.2c.8.6 1 1.7.4 2.6-.6.8-1.7 1-2.6.4-.8-.6-1-1.7-.4-2.6s1.8-1 2.6-.4z" className="primary-fill"/>
		                <path id="minute_tick_9_" d="M395.5 1097.6c-.9 2.6-.1 5.5 2 7.3l-2.3 6.4 4.4-5.2c2.6.9 5.5.1 7.3-2l6.4 2.3-5.2-4.4c.9-2.6.1-5.5-2-7.3l2.3-6.4-4.4 5.2c-2.6-.9-5.5-.1-7.3 2l-6.4-2.3 5.2 4.4zm7.9-.6c1.6.9 2.1 2.9 1.2 4.5-.9 1.6-2.9 2.1-4.5 1.2-1.6-.9-2.1-2.9-1.2-4.5 1-1.5 3-2.1 4.5-1.2z" className="primary-fill"/>
		                <path id="minute_tick_8_" d="M906.3 212.9c-.9 2.6-.1 5.5 2 7.3l-2.3 6.4 4.4-5.2c2.6.9 5.5.1 7.3-2l6.4 2.3-5.2-4.4c.9-2.6.1-5.5-2-7.3l2.3-6.4-4.4 5.2c-2.6-.9-5.5-.1-7.3 2l-6.4-2.3 5.2 4.4zm7.9-.6c1.6.9 2.1 2.9 1.2 4.5s-2.9 2.1-4.5 1.2c-1.6-.9-2.1-2.9-1.2-4.5s3-2.1 4.5-1.2z" className="primary-fill"/>
		                <path id="minute_tick_7_" d="M445.7 1123.3c-.4 1.5.2 3.1 1.5 4l-.9 3.7 2.2-3.2c1.5.4 3.1-.2 4-1.5l3.7.9-3.2-2.2c.4-1.5-.2-3.1-1.5-4l.9-3.7-2.2 3.2c-1.5-.4-3.1.2-4 1.5l-3.7-.9 3.2 2.2zm4.5-.8c.9.4 1.3 1.5.9 2.4-.4.9-1.5 1.3-2.4.9-.9-.4-1.3-1.5-.9-2.4.4-.9 1.4-1.3 2.4-.9z" className="primary-fill"/>
		                <path id="minute_tick_6_" d="M861.3 190c-.4 1.5.2 3.1 1.5 4l-.9 3.7 2.2-3.2c1.5.4 3.1-.2 4-1.5l3.7.9-3.2-2.2c.4-1.5-.2-3.1-1.5-4l.9-3.7-2.2 3.2c-1.5-.4-3.1.2-4 1.5l-3.7-.9 3.2 2.2zm4.4-.8c.9.4 1.3 1.5.9 2.4-.4.9-1.5 1.3-2.4.9s-1.3-1.5-.9-2.4c.4-.9 1.5-1.3 2.4-.9z" className="primary-fill"/>
		                <path id="minute_tick_5_" d="M495.6 1142.8c-.2 1.5.6 3.1 1.9 3.8l-.5 3.8 1.8-3.4c1.5.2 3.1-.6 3.8-1.9l3.8.5-3.4-1.8c.2-1.5-.6-3.1-1.9-3.8l.5-3.8-1.8 3.4c-1.5-.2-3.1.6-3.8 1.9l-3.8-.5 3.4 1.8zm4.3-1.2c1 .3 1.5 1.3 1.2 2.3-.3 1-1.3 1.5-2.3 1.2-1-.3-1.5-1.3-1.2-2.3.3-1 1.3-1.6 2.3-1.2z" className="primary-fill"/>
		                <path id="minute_tick_4_" d="M811.3 171.2c-.2 1.5.6 3.1 1.9 3.8l-.5 3.8 1.8-3.4c1.5.2 3.1-.6 3.8-1.9l3.8.5-3.4-1.8c.2-1.5-.6-3.1-1.9-3.8l.5-3.8-1.8 3.4c-1.5-.2-3.1.6-3.8 1.9l-3.8-.5 3.4 1.8zm4.3-1.2c1 .3 1.5 1.3 1.2 2.3s-1.3 1.5-2.3 1.2c-1-.3-1.5-1.3-1.2-2.3s1.3-1.6 2.3-1.2z" className="primary-fill"/>
		                <path id="minute_tick_3_" d="M547.2 1157c0 1.6.9 3 2.3 3.6l-.1 3.8 1.5-3.6c1.6 0 3-.9 3.6-2.3l3.8.1-3.6-1.5c0-1.6-.9-3-2.3-3.6l.1-3.8-1.5 3.6c-1.6 0-3 .9-3.6 2.3l-3.8-.1 3.6 1.5zm4.2-1.7c1 .2 1.6 1.2 1.4 2.2-.2 1-1.2 1.6-2.2 1.4s-1.6-1.2-1.4-2.2c.2-.9 1.2-1.6 2.2-1.4z" className="primary-fill"/>
		                <path id="minute_tick_2_" d="M759.6 157.8c0 1.6.9 3 2.3 3.6l-.1 3.8 1.5-3.6c1.6 0 3-.9 3.6-2.3l3.8.1-3.6-1.5c0-1.6-.9-3-2.3-3.6l.1-3.8-1.5 3.6c-1.6 0-3 .9-3.6 2.3l-3.8-.1 3.6 1.5zm4.2-1.7c1 .2 1.6 1.2 1.4 2.2-.2 1-1.2 1.6-2.2 1.4s-1.6-1.2-1.4-2.2c.2-1 1.2-1.6 2.2-1.4z" className="primary-fill"/>
		                <path id="minute_tick_1_" d="M600 1165.8c.1 1.6 1.2 2.9 2.7 3.3l.3 3.8 1.1-3.7c1.6-.1 2.9-1.2 3.3-2.7l3.8-.3-3.7-1.1c-.1-1.6-1.2-2.9-2.7-3.3l-.3-3.8-1.1 3.7c-1.6.1-2.9 1.2-3.3 2.7l-3.8.3 3.7 1.1zm4-2.1c1 .1 1.7 1 1.6 2-.1 1-1 1.7-2 1.6s-1.7-1-1.6-2c.1-1 1-1.7 2-1.6z" className="primary-fill"/>
		                <path id="minute_tick" d="M706.8 149.8c.1 1.6 1.2 2.9 2.7 3.3l.3 3.8 1.1-3.7c1.6-.1 2.9-1.2 3.3-2.7l3.8-.3-3.7-1.1c-.1-1.6-1.2-2.9-2.7-3.3l-.3-3.8-1.1 3.7c-1.6.1-2.9 1.2-3.3 2.7l-3.8.3 3.7 1.1zm4-2.1c1 .1 1.7 1 1.6 2s-1 1.7-2 1.6c-1-.1-1.7-1-1.6-2s1-1.7 2-1.6z" className="primary-fill"/>
		            </g>
		            <g id="hands">
		                <g id="hour_time">
		                    <g id="hour_hand">
		                        <path id="hh_frame" d="M547.2 107.5h220v1100h-220z" className="st11"/>
		                        <path id="hh_arrow" d="M716.1 421.9c1.5-5.3 2.3-10.8 2.3-16.6 0-6.9-1.2-13.5-3.3-19.7-4.7 2.6-9.6 4.9-14.6 6.8 1.2 4.1 1.9 8.4 1.9 12.9 0 24.9-20.3 45.2-45.2 45.2-24.9 0-45.2-20.3-45.2-45.2 0-4.5.7-8.8 1.9-12.9-5-2-9.9-4.2-14.6-6.8-2.1 6.2-3.3 12.8-3.3 19.7 0 5.7.8 11.3 2.3 16.6-28.1 19-46.6 51.1-46.6 87.4 0 47 30.9 86.9 73.4 100.5-15.3 10.3-25.4 27.8-25.4 47.7 0 31.8 25.7 57.5 57.5 57.5s57.5-25.7 57.5-57.5c0-19.9-10.1-37.4-25.4-47.7 42.5-13.6 73.4-53.5 73.4-100.5 0-36.3-18.5-68.5-46.6-87.4zm-77.7 181.2c-2.1.7-4.1 1.5-6.1 2.5-42.9-11.1-74.6-50.1-74.6-96.3 0-33.7 16.8-63.5 42.6-81.5 1.3 3.2 2.8 6.3 4.5 9.2-22.4 16.3-37 42.6-37 72.4 0 43.3 30.9 79.5 71.9 87.7l-1.3 6zm23.7-69.1c11.5-2.3 20.1-12.4 20.1-24.5 0-13.8-11.2-25-25-25s-25 11.2-25 25c0 12.1 8.6 22.2 20.1 24.5l-9.5 47.3c-33.6-6.7-59-36.4-59-72 0-24.7 12.3-46.6 31-59.9 11 10.6 25.9 17.1 42.4 17.1 16.4 0 31.4-6.5 42.4-17.1 18.8 13.3 31 35.2 31 59.9 0 35.5-25.4 65.3-59 72l-9.5-47.3zm19.9 71.6c-2-.9-4-1.8-6.1-2.5l-1.2-6.2c40.9-8.2 71.9-44.4 71.9-87.7 0-29.7-14.6-56.1-37-72.4 1.8-2.9 3.3-6 4.5-9.1 25.7 18 42.5 47.8 42.5 81.5.1 46.4-31.7 85.4-74.6 96.4z" className="hour-hand"/>
		                        <path id="hh_nib" d="M657.2 360.1c20.5 0 37.8 13.7 43.3 32.3 5-2 9.9-4.2 14.6-6.8-6.9-20.1-23.9-35.5-44.9-40.1l-13-64.9-13 64.9c-21 4.6-38.1 20-44.9 40.1 4.7 2.6 9.6 4.9 14.6 6.8 5.5-18.6 22.8-32.3 43.3-32.3z" className="primary-fill"/>
		                    </g>
		                    <circle id="hour_time_frame" cx="657.2" cy="657.7" r="550" className="st11"/>
		                </g>
		                <g id="minute_time">
		                    <g id="minute_hand">
		                        <path id="mh_frame" d="M547.2 107.5h220v1100h-220z" className="st11"/>
		                        <path id="mh_arrow" d="M689.5 754.9c-3.1-11.1-8.9-33.7-11.1-60.4 12.8-7.4 21.5-21.2 21.5-37 0-13.4-6.2-25.3-15.8-33.1 3.2-11.3 7.9-24.7 14.3-36.3 1 .3 2.1.4 3.3.4 7.2 0 13-5.8 13-13s-5.8-13-13-13c-5.3 0-9.8 3.1-11.8 7.6-23.9-5.8-42.1-14.7-57.5-30.9 4-4.6 6.4-10.6 6.4-17.2 0-8.5-4-16.1-10.3-21 11.6-27.7 29.8-88.7 33.6-215.8-3.3 0-6.6-.4-9.8 0-1.1 107.5-23.7 170.5-42.7 210.4-13.4 1.4-23.8 12.6-23.8 26.4 0 13.9 10.8 25.3 24.4 26.4 17.2 26.5 38.4 40.4 52.4 46.1.7.3.9 1.1.3 1.5-8.1 5.9-14.9 13.2-20.6 21.5-16.2 6.1-27.7 21.7-27.7 40 0 7.3 1.8 14.1 5 20.1-6.7 35.6-5.3 70.7-5.1 85.4-13 11.7-21.1 28.7-21.1 47.5 0 20.5 9.7 38.8 24.7 50.6l-10.6 16.8c-1.9 3-1 7.1 2 9 1.1.7 2.3 1 3.5 1 2.2 0 4.3-1.1 5.5-3l10.6-16.8c8.6 4.3 18.2 6.7 28.4 6.7 35.4 0 64.2-28.8 64.2-64.2 0-23.9-13-44.6-32.2-55.7zm-77.3-214.4c-10.2 0-18.5-8.3-18.5-18.5s8.3-18.5 18.5-18.5 18.5 8.3 18.5 18.5-8.3 18.5-18.5 18.5zm45.3 323.2c-8.1 0-15.7-1.8-22.6-5l16-25.4c1.9.5 3.9.8 5.9.8 12.5 0 22.7-10.1 22.7-22.7s-10.1-22.7-22.7-22.7c-12.5 0-22.7 10.1-22.7 22.7 0 5.8 2.2 11 5.7 15L624 851.7c-12-9.8-19.6-24.6-19.6-41.2 0-29.3 23.9-53.2 53.2-53.2 29.3 0 53.2 23.9 53.2 53.2s-24 53.2-53.3 53.2z" className="minute-hand"/>
		                        <path id="mh_nib" d="M662.2 186.9c0-3.1-2.8-5.5-6-4.9-2.4.5-4 2.7-4 5.1v98.2c3.3-.4 6.6 0 9.8 0 .1-2.4.2-98.4.2-98.4z" className="primary-fill"/>
		                    </g>
		                    <circle id="minute_time_frame" cx="657.2" cy="657.7" r="550" className="st11"/>
		                </g>
		                <g id="second_time">
		                    <g id="second_hand">
		                        <path id="sh_frame" d="M607.2 107.5h100v1100h-100z" className="st11"/>
		                        <path id="sh_arrow" d="M673.8 736l-1.5-53.4c8.7-5.2 14.6-14.7 14.6-25.6 0-11.3-6.3-21.2-15.7-26.2l-.2-11.4c-2.2-.4-3.9-2.3-3.9-4.6l-5.8-329.6c-2.6-.1-5.3 0-7.9 0l-5.8 329.6c0 2.5-2 4.5-4.5 4.7l-.2 11.5c-9.1 5.1-15.3 14.8-15.3 26 0 10.7 5.7 20.2 14.2 25.4l-1.6 53.4c-34.3 7.6-60 38.2-60 74.7 0 42.2 34.3 76.5 76.5 76.5s76.5-34.3 76.5-76.5c0-36.3-25.4-66.8-59.4-74.5zm-17.1 141c-36.7 0-66.5-29.8-66.5-66.5 0-32.8 23.9-60.2 55.3-65.5l5 4.4v28.5c-15.5 3.1-27.2 16.8-27.2 33.3 0 18.8 15.2 34 34 34s34-15.2 34-34c0-16.5-11.7-30.2-27.2-33.3v-28.5l4.6-4.2c31.1 5.6 54.7 32.8 54.7 65.4-.2 36.6-30 66.4-66.7 66.4z" className="second-hand"/>
		                        <path id="sh_nib" d="M661.3 285.2L659.5 182c-.7-.4-1.4-.6-2.3-.6-.7 0-1.4.2-2 .4l-1.8 103.4c2.6-.1 5.3-.2 7.9 0z" className="primary-fill"/>
		                        <g id="center_screw">
		                            ...
		                            <circle cx="657.2" cy="657.5" r="16.3" className="st60"/>
		                            <linearGradient id="SVGID_52_" x1="662.861" x2="651.031" y1="663.476" y2="651.646" gradientUnits="userSpaceOnUse">
		                                <stop offset="0" style="stop-color:#666666"/>
		                                <stop offset="1" style="stop-color:#0D0D0D"/>
		                            </linearGradient>
		                            <path d="M661 650.6h-8.1l-4 7 4 7h8.1l4-7z" className="st61"/>
		                        </g>
		                    </g>
		                    <circle id="second_time_frame" cx="657.2" cy="657.7" r="550" className="st11"/>
		                </g>
		            </g>
		        </svg>
		        </div>
